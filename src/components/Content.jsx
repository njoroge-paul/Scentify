      ...
      <div className="flex justify-center mt-4 mb-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-16">
        <form className="flex items-center justify-between mt-6 gap-6 lg:gap-8 xl:gap-10">
          <input
            ...
            type="search"
            placeholder="Search..."
            className="search-input lg:p-2 xl:p-3 border-black border-2 placeholder:text-center rounded sm:w-[100%] md:w-[80%] lg:w-[60%] xl:w-[50%] hover:w-[40rem] ease-in-out duration-1000 hover:border-[#E2AA1D]"
          />
          ...
          <button type="submit" className="hover:search-button">
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className="size-8 text-[#E2AA1D] bold hover:text-black "
            >
              <path
                strokeLinecap="round"
        ...
        {filteredPerfumes.map(perfume => (
          <div key={perfume.id} className="flex flex-col items-center p-8 bg-white text-gray-800">
            ...
            <button 
             ...
             className="rounded bg-[#E2AA1D] mt-3 sm:w-[50%] md:[25%] lg:w-[40%] p-2">
              Add-To-Cart <h1>${perfume.price}</h1>
            </button>
          </div>
        ))}
      </div>
